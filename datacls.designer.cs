...
namespace exam
{
	...
	public partial class booth : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _cameralocationtype;
    ...
    partial void OnselboothChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_cameralocationtype", DbType = "NVarChar(MAX) NOT NULL", CanBeNull = false)]
		public string cameralocationtype
		{
			get
			{
				return this._cameralocationtype;
			}
			set
			{
				if ((this._cameralocationtype != value))
				{
					this.OnlocationChanging(value);
					this.SendPropertyChanging();
					this._cameralocationtype = value;
					this.SendPropertyChanged("cameralocationtype");
					this.OnlocationChanged();
				}
			}
		}
