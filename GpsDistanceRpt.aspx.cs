...
namespace exam
{
    public partial class GpsDistanceRpt : System.Web.UI.Page
    {
        ...
        { 
            ...
            DataSet ds = _data.GetgpsdailyReport(fromdate, ddlDistrict.SelectedValue, ddlAssembly.SelectedValue,0);
