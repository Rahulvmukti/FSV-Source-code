    ...
    public partial class BoothMaster : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Submit")
            {
                ...
                Type.Text = ds.Tables[0].Rows[0]["cameralocationtype"].ToString();
...

        {
            try
            {
                ...
                message.CC.Add(new MailAddress(ConfigurationManager.AppSettings["MailCC"].ToString()));
                message.Subject = "Camera Activity In Booth Of  " + ConfigurationManager.AppSettings["Electionnamevalues"].ToString();
