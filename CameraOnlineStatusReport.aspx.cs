...
namespace exam
{
    public partial class CameraOnlineStatusReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Session["MenuName"] = "CameraOnlineStatus";
                stateid = Convert.ToInt32(ConfigurationManager.AppSettings["stateid"]);
                if (!IsPostBack)
                {
                    FromDt.Text = DateTime.Now.AddDays(-1).ToString("dd/MM/yyyy");
        ...
        { 
            ...
            //    acname = "";
            //}
            DataSet ds = _data.GetCameraOnlineStatusReport(ddlDistrict.SelectedValue, acname, fromdate);
            dsReport = ds; 
        }
