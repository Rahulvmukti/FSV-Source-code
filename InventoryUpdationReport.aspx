                  ...
                  <div class="card-header row"> 
                     ...
                     <div class="form-group">
                       ...
                       <div class="navbar-nav ml-auto"> 
                           <h5>Repair/Replacement Report</h5>
                           </div> 
                      </div>
                 ...
                 <table  id="datatbl" class="table table-head-fixed">
                       <thead>
                                                <tr>
                                                    ...
                                                    <th class="p-thin text-left">Remark</th>
                                                </tr>
                                                    </thead>
                                                <tbody>
                                               ...
                                               <td class="p-thin text-left"><%=dsReport.Tables[0].Rows[i]["Remarks"].ToString() %></td>
                                                    </tr>
            ...
            $j('#datatbl').DataTable({
                ...
                buttons: [
                    //'copy', 'csv', 'excel', 'pdf', 'print'
                    {
                        ...
                        pageSize: 'LEGAL',
                        title: '<%=ConfigurationManager.AppSettings["ConsolidatedCameraOffline_2_excel_title"].ToString()%> - Inventory Updation Report' + '-' + newdate,
                  ...
                  },
                  {
                      ...
                      orientation: 'landscape',
                      pageSize: 'LEGAL', 
                      title: '<%=ConfigurationManager.AppSettings["ConsolidatedCameraOffline_2_pdf_title"].ToString()%> - Inventory Updation Report' + '-' + newdate,
