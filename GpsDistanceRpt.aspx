<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="GpsDistanceRpt.aspx.cs" Inherits="exam.GpsDistanceRpt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                       ...
                       <thead>
                                                <tr>
                                                     <th class="p-thin text-left tdist">District</th>
                                                        ...
                                                        <th class="p-thin text-left tdid">Start Distance</th>
                                                        <th class="p-thin text-left tdate">Last Distane</th>
                                                        <th class="p-thin text-center">Start Location</th>
                                                        <th class="p-thin text-center">Last Location</th>
                                                        <th class="p-thin text-center">Total KM</th>
                                                </tr>
                                                    </thead>
                     <tbody>
                                              <% if (dsReport != null && dsReport.Tables[0].Rows.Count > 0 )%>
                                                    ...
                                                    <tr >
                                                        ...
                                                        <td class="p-thin text-left tpsno"><%=dsReport.Tables[0].Rows[i]["VehicleName"].ToString() %></td>
                                                        <td class="p-thin text-left tlocation"><%=dsReport.Tables[0].Rows[i]["StartDist"].ToString() %></td>
                                                           <td class="p-thin text-left tdid"><%=dsReport.Tables[0].Rows[i]["lastDist"].ToString() %></td>
                                                           <td class="p-thin text-left tdid"><%=dsReport.Tables[0].Rows[i]["StartLocation"].ToString() %></td>
                                                           <td class="p-thin text-left tdid"><%=dsReport.Tables[0].Rows[i]["lastlocation"].ToString() %></td>
                                                           <td class="p-thin text-left tdid"><%=dsReport.Tables[0].Rows[i]["TotalKm"].ToString() %></td>
                                                          </tr>
                                                  <%}%>   <% }  %> 
                         </tbody>
                     </table>
            ...
            $j('#datatbl').DataTable({
                ...
                buttons: [
                    //'copy', 'csv', 'excel', 'pdf', 'print'
                    {
                        ...
                        pageSize: 'LEGAL', 
                      title: '<%=ConfigurationManager.AppSettings["CameraStatusReport_2_excel_title"].ToString()%> - GPS Distance Report' + '-' + newdate,
                  ...
                  },
                  {
                      ...
                      orientation: 'landscape',
                      pageSize: 'LEGAL', 
                      title: '<%=ConfigurationManager.AppSettings["CameraStatusReport_2_pdf_title"].ToString()%> - GPS Distance Report' + '-' + newdate,
    ...
    <script type="text/javascript"> 
        ...
        $('#GpsdistanceReport').addClass('active');
    </script>
</asp:Content>
